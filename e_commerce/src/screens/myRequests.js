        ...
        <View style={styles.title}>
         ...
         <Text style={{alignSelf: "center", color: "white", fontSize: wp("4%"), fontWeight: "bold", paddingLeft: wp("3%")}}>{item.status}</Text>
          ...
          <View style={{flexDirection: "row"}}>
            ...
            <TouchableOpacity style={styles.date} onPress={()=>callme(item.ownerPhoneNumber)}>
            ...
            <View>
            <TouchableOpacity style={styles.date} onPress={()=>addId(item._id, item.ownerName, item.requestorName, props)}>
